...
public class SFTPUtil {
	 ...
	 * @param dir : 创建的文件夹名字
	 */
	public static Boolean mkdir(String dir,String host,int port,String username,String password) {
		Session s = getSession(host, port, username,password);
	 ...
	 * @return :
	 */
	public static Boolean uploadFile(String dir, File file,String host,int port,String username,String password) {
		Session s = getSession(host, port, username,password);
		Channel channel = getChannel(s);
		ChannelSftp sftp = (ChannelSftp) channel;
		Boolean result =false;
	 ...
	 * @param sftp
	 */
	public static Boolean download(String directory, String downloadFile, String saveFile,String host,
